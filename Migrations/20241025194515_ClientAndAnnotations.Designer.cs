...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241025194515_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 25, 15, 45, 15, 92, DateTimeKind.Local).AddTicks(9521),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 25, 15, 45, 15, 92, DateTimeKind.Local).AddTicks(9572),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 25, 15, 45, 15, 92, DateTimeKind.Local).AddTicks(9576),
                            ServicesID = 5
                        });
                });
